                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="gallery-img">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="resources/user_assets/img/gallery/gallery1.png" class="mb-30" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="resources/user_assets/img/gallery/gallery2.png" class="mb-30" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="resources/user_assets/img/gallery/gallery3.png"  class="mb-30"alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="resources/user_assets/img/gallery/gallery4.png"  class="mb-30"alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="map">
                            <img src="resources/user_assets/img/gallery/map.png" alt="">
                        </div>
